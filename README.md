...
This Repository contains analysis of sales data of different teams for a fiscal year 2019-20. Where you can find the analysis of teams through Dashboard or go to the Tabular to understand what data is present. Visualization changes if the data within the file is change this makes the dashboard dynamic. 
